    ...
    <div>
        <div class="flex flex-col gap-2">
            ...
            <div class="flex flex-col">
                ...
                <div class="">
                    <p class = "text-black/[0.6] font-[500] text-[14px]">Menginap di tempat {{ owner }}</p>
                    <p class = "text-black/[0.6] font-[500] text-[14px]">{{ date }}</p>
                    <p class = "text-black/[0.6] text-[15px] font-[500] my-2"><span class = "text-black">Rp. {{ price }}</span> malam</p>
                </div>
            </div>
        </div>
    </div>
